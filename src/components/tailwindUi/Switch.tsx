...
const Switch: React.FC<SwitchProps> = ({ label, checked, onCheckedChange, disabled = false, className }) => {


    const style = `mr-2 mt-[0.3rem] h-3.5 w-8 appearance-none rounded-[0.4375rem] bg-neutral-300
     ...
     before:bg-transparent before:content-[''] after:absolute after:z-[2] after:-mt-[0.1875rem]
      ...
      checked:after:border-none checked:after:bg-neutral checked:after:shadow-[0_3px_1px_-2px_rgba(0,0,0,0.2),_0_2px_2px_0_rgba(0,0,0,0.14),_0_1px_5px_0_rgba(0,0,0,0.12)] 
